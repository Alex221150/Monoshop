...
<div class="album py-5 bg-body-tertiary">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <form method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <img src="<?= 'upload/' . htmlspecialchars($image) ?>" alt="details en image" height="300" width="300">
                    </div>
                    <div class="mb-3">
                        <label for="nom" class="form-label"><strong>Nom du produit</strong></label>
                        <input required type="text" class="form-control" id="nom" name="productName" value="<?= htmlspecialchars($nom) ?>" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="prix" class="form-label"><strong>Son prix</strong></label>
                        <input required type="number" class="form-control" id="prix" name="productPrice" value="<?= htmlspecialchars($prix) ?>" disabled>
                    </div>
                    <div class="mb-3">
            ...
            <!-- Image à droite -->
            <div class="col-md-6">
                <img src="../view/3.png" class="img-fluid" alt="Image promotionnelle" height="740" width="740">
            </div>
        </div>
    </div>
</div>
